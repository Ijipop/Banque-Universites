...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupe_selection.setGeometry(QRect(10, 10, 781, 151))
        font = QFont()
        font.setBold(True)
        self.groupe_selection.setFont(font)
        self.widget = QWidget(self.groupe_selection)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(10, 20, 761, 121))
        self.layout_selection = QVBoxLayout(self.widget)
        self.layout_selection.setSpacing(0)
        ...
        self.labelUniversites = QLabel(self.widget)
        ...
        self.comboBox_universites = QComboBox(self.widget)
        ...
        self.label_facultes = QLabel(self.widget)
        ...
        self.comboBox_facultes = QComboBox(self.widget)
        ...
        self.pushButton_AfficherSelection = QPushButton(self.widget)
        ...
        self.groupe_ajout_universite = QGroupBox(self.centralwidget)
        self.groupe_ajout_universite.setObjectName(u"groupe_ajout_universite")
        self.groupe_ajout_universite.setGeometry(QRect(10, 160, 781, 151))
        self.groupe_ajout_universite.setFont(font)
        self.widget1 = QWidget(self.groupe_ajout_universite)
        self.widget1.setObjectName(u"widget1")
        self.widget1.setGeometry(QRect(10, 20, 761, 121))
        self.layout_ajout_universite = QVBoxLayout(self.widget1)
        ...
        self.layout_universite = QHBoxLayout()
        self.layout_universite.setObjectName(u"layout_universite")
        self.layout_nom_universite = QVBoxLayout()
        self.layout_nom_universite.setObjectName(u"layout_nom_universite")
        self.label_nom_universite = QLabel(self.widget1)
        ...
        self.lineEdit_nom_universite = QLineEdit(self.widget1)
        ...
        self.lineEdit_ville_universite = QLineEdit(self.widget1)
        ...
        self.layout_universite.addLayout(self.layout_ville_universite)

        self.layout_code_universite = QVBoxLayout()
        self.layout_code_universite.setObjectName(u"layout_code_universite")
        self.label_code_universite = QLabel(self.widget1)
        ...
        self.lineEdit_code_universite = QLineEdit(self.widget1)
        ...
        self.lineEdit_annee_universite = QLineEdit(self.widget1)
        ...
        self.layout_universite.addLayout(self.layout_annee_universite)


        self.layout_ajout_universite.addLayout(self.layout_universite)

        self.pushButton_AjouterUniversite = QPushButton(self.widget1)
        ...
        self.groupe_ajout_faculte = QGroupBox(self.centralwidget)
        self.groupe_ajout_faculte.setObjectName(u"groupe_ajout_faculte")
        self.groupe_ajout_faculte.setGeometry(QRect(10, 310, 781, 211))
        self.groupe_ajout_faculte.setFont(font)
        self.widget2 = QWidget(self.groupe_ajout_faculte)
        self.widget2.setObjectName(u"widget2")
        self.widget2.setGeometry(QRect(10, 30, 761, 171))
        ...
        self.label_nom_faculte = QLabel(self.widget2)
        ...
        self.lineEdit_nom_faculte = QLineEdit(self.widget2)
        ...
        self.horizontalLayout.addLayout(self.layout_nom_faculte)

        self.layout_code_faculte = QVBoxLayout()
        self.layout_code_faculte.setObjectName(u"layout_code_faculte")
        self.label_code_faculte = QLabel(self.widget2)
        ...
        self.lineEdit_code_faculte = QLineEdit(self.widget2)
        ...
        self.lineEditl_nbEtudiants_faculte = QLineEdit(self.widget2)
        ...
        self.horizontalLayout.addLayout(self.layout_nbEtudiants_faculte)
        ...
        self.label_universite_faculte = QLabel(self.widget2)
        ...
        self.comboBox_universite_faculte = QComboBox(self.widget2)
        ...
        self.verticalLayout.addLayout(self.layout_universite_faculte)

        self.pushButton_AjouterFaculte = QPushButton(self.widget2)
        ...
        self.verticalLayout.addWidget(self.pushButton_AjouterFaculte)

        self.groupe_resultats = QGroupBox(self.centralwidget)
        self.groupe_resultats.setObjectName(u"groupe_resultats")
        self.groupe_resultats.setGeometry(QRect(10, 520, 781, 251))
        self.groupe_resultats.setFont(font)
        self.widget3 = QWidget(self.groupe_resultats)
        self.widget3.setObjectName(u"widget3")
        self.widget3.setGeometry(QRect(10, 20, 761, 221))
        self.layout_resultats = QVBoxLayout(self.widget3)
        self.layout_resultats.setObjectName(u"layout_resultats")
        self.layout_resultats.setContentsMargins(0, 0, 0, 0)
        self.laout_buttons = QHBoxLayout()
        self.laout_buttons.setObjectName(u"laout_buttons")
        self.pushButton_VoirStats = QPushButton(self.widget3)
        self.pushButton_VoirStats.setObjectName(u"pushButton_VoirStats")
        self.pushButton_VoirStats.setFont(font1)

        self.laout_buttons.addWidget(self.pushButton_VoirStats)

        self.pushButton_Demo = QPushButton(self.widget3)
        self.pushButton_Demo.setObjectName(u"pushButton_Demo")
        self.pushButton_Demo.setFont(font1)

        self.laout_buttons.addWidget(self.pushButton_Demo)


        self.layout_resultats.addLayout(self.laout_buttons)

        self.textEdit_resultats = QTextEdit(self.widget3)
        self.textEdit_resultats.setObjectName(u"textEdit_resultats")

        self.layout_resultats.addWidget(self.textEdit_resultats)

        self.pushButton_ViderMessages = QPushButton(self.widget3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_code_universite.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Code unique", None))
